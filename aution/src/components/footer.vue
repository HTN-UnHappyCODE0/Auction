    ...
    >
      <div class="absolute z-10 flex w-full h-full">
        ...
        >
          ...
          <div class="mt-10 flex justify-center gap-4 text-center">
            <a
              href="#"
              class="block w-full rounded-full bg-black border-gray-800 px-6 py-3 text-sm font-medium text-white shadow hover:bg-blue-700 focus:outline-none focus:ring-gray-100 sm:w-auto"
            >
              Get the App
            </a>
          </div>
        ...
        <div class="absolute top-0 right-0 flex w-full h-full">
          <div class="w-1/3 h-full bg-gray-300"></div>
        </div>
      </div>
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
          <div>
            ...
            <ul class="text-gray-500 font-medium">
              <li class="mb-4">
                <a href="https://flowbite.com/" class="hover:underline">Jobs</a>
              </li>
              <li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center"
          >© 2024 <a href="" class="hover:underline">Auction</a
          ><span class="mr-4"></span> Terms of Use<span class="mr-4"></span>
          Privacy Policy<span class="mr-4"></span>
          Security
        </span>
