<template>
  ...
  <div class="h-full mt-10 mx-auto max-w-screen-xl">
    ...
    <ul class="my-8 mx-8 columns-2 lg:columns-3">
      <li v-for="item of searchnameProduct" :key="item.product_id" class="h-full">
        <router-link
          :to="{ name: 'productDetail', params: { product_id: item.product_id } }"
        >
          <div class="group min-w-10 mb-5 relative">
            ...
            >
              ...
              <div class="mt-2 ">
                  ...
                  <h4 class="text-sm font-bold text-gray-500">{{item.description}}</h4>
